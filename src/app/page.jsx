  ...
  return (
    <section className="text-center">
      ...
      <div className="mt-32 flex flex-wrap justify-center gap-7">
        ...
        <button><a href="/SignIn" className="bg-#1152FD text-white p-4 px-10 font-bold rounded-2xl  hover:bg-white hover:text-blue-500 hover:transition">Sign In</a></button>
      </div>
    </section>
  );
}
